				...
				<div className="row">
					...
					<div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div className="post-entry">
							<Link to="/" className="post-thumbnail"><img src="images/post-1.jpg" alt="pic" className="img-fluid" /></Link>
					...
					<div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div className="post-entry">
							<Link to="/" className="post-thumbnail"><img src="images/post-2.jpg" alt="pic" className="img-fluid" /></Link>
							<div className="post-content-entry">
					...
					<div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div className="post-entry">
							<Link to="/" className="post-thumbnail"><img src="images/post-3.jpg" alt="pic" className="img-fluid" /></Link>
							<div className="post-content-entry">
